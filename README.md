...
- 🗄️ Conhecimentos em **PostgreSQL**, **Docker** e **Git**
- ⚙️ Foco em **Clean Code**, arquitetura de software e boas práticas
...
- Criação e manutenção de bancos de dados SQL
- Autenticação e autorização com JWT
- Desenvolvimento de interfaces com React e TypeScript
- Consumo e desenvolvimento de APIs
...
<!--
**OtolineLeo/OtolineLeo** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
